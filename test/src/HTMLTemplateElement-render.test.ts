...
export default Promise.all([
	test(new xjs.DocumentFragment(new xjs.HTMLTemplateElement(x).render(function (frag, data, _opts) {
	...
	test(new xjs.DocumentFragment(new xjs.HTMLTemplateElement(x).render(function (frag, data, opts) {
	...
	test(new xjs.DocumentFragment(new xjs.HTMLTemplateElement(x).render(function (frag, _data, _opts) {
	...
	test((() => {
		...
		return new xjs.DocumentFragment(new xjs.HTMLTemplateElement(x)
			.render(renderingFn,'hello world', { blank: false }, {id:0})
		).trimInner().innerHTML()
	})(), '<slot name="put-text-here">0</slot>'),
	test(new xjs.DocumentFragment(new xjs.HTMLTemplateElement(x).render(
