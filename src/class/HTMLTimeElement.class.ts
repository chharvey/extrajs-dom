...
export default class xjs_HTMLTimeElement extends xjs_HTMLElement {
  /**
   * Construct a new xjs_HTMLTimeElement object.
  ...
  /**
   * This method accepts a {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date|Date} object as the value to set.
